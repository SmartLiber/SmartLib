...
public class MainFrame extends JFrame {
    ...
    private void initMenuBar() {
        ...
        // === 3. 数据分析 ===
        JMenu menuData = new JMenu("数据分析");
        menuData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JMenuItem itemDataAnalysis = new JMenuItem("数据概览");
        itemDataAnalysis.setFont(new Font("微软雅黑", Font.PLAIN, 13));
        itemDataAnalysis.addActionListener(e -> openDataAnalysis());

        menuData.add(itemDataAnalysis);
    ...
    private void initUI() {
        ...
        btnGrid.add(createFuncButton("浏览图书", "picture/浏览图书.png", new Color(41, 128, 185),
                e -> browseBooks()));
        btnGrid.add(createFuncButton("智能小助手", "picture/智能小助手.png", new Color(46, 134, 70),
                e -> openAiAgent()));
        btnGrid.add(createFuncButton("个人信息", "picture/个人信息.png", new Color(230, 126, 34),
                e -> showPersonalInfo()));
        btnGrid.add(createFuncButton("借阅管理", "picture/借阅管理.png", new Color(142, 68, 173),
                e -> openBorrowManage()));
    ...
    private JButton createFuncButton(String text, String iconPath, Color bgColor,
    ...
    private void openDataAnalysis() {
        int totalUsers = userService.getTotalUserCount();
        int totalBooks = new BookDAO().getAllBooks().size();
        JOptionPane.showMessageDialog(this,
                " 数据概览\n\n" +
                        "总用户数: " + totalUsers + "\n" +
                        "总图书数: " + totalBooks + "\n" +
